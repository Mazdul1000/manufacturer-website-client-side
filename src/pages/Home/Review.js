...
const Review = ({review}) => {
  ...
  <div class="flex justify-center md:justify-end -mt-16">
    <img class="w-20 h-20 object-cover rounded-full border-2 border-primary" src={avatar} alt=''/>
  </div>
  <div>
    <h2 class="text-gray-800 text-2xl font-semibold">Product Name: {productName}</h2>
